...
# We can add multiple databases. For example, MySQL + MongoDB + PostgreSQL
DATABASES = {
    'default': {
...
# your email address
EMAIL_HOST_USER = 'victormakwaitat@gmail.com'
